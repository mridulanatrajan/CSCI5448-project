...
public class ContactManagement {
	...
	public void start() {
		...
		addnewcontact.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e1 ) {
				...
				newframe.setContentPane(newpanel1);
				newframe.repaint();
				newframe.setLayout(new GridLayout(2,2));
				
				//newcontname.setPreferredSize(new Dimension(150, 50));
				add1.setPreferredSize(new Dimension(150,50));
				goback2.setPreferredSize(new Dimension(150,50));
	...
	{
		ContactManagement obj1 = new ContactManagement();
		obj1.start();
	}
